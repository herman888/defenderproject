...
if "%choice%"=="5" ( call :run test      & goto after )
if "%choice%"=="6" ( call :run docs      & goto after )
...
echo   Unknown mode "%~1". Use: sim ^| swarm ^| overwhelm ^| swarm3d ^| test ^| docs
goto :eof
