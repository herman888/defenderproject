...
!!! warning "Historical reference"
    This page preserves older board and build notes. Use the current
    [flight-controller](../hardware/flight-controllers.md) and
    [flashing](../firmware/flashing.md) procedures for active work.
